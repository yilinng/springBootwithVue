...
<template>
  <nav class="flex justify-between mt-2 shadow-xl">
    <div class="left_nav flex flex-row items-center">
      <div class="header">
      ...
      <Transition :duration="550" name="slide-fade">
        ...
        >
          ...
          <ul class="flex flex-col space-y-4 text-center">
            ...
            <li v-if="userStore.token">
              <button class="navbar-brand text-2xl" @click="logout">
                logout
              </button>
            </li>
          </ul>
    ...
    <div class="right_nav">
      <ul class="flex-row space-x-4 hidden md:flex">
        <li v-if="!userStore.token">
          <RouterLink class="navbar-brand text-2xl" to="/login"
            >login</RouterLink
          >
      ...
      <div class="menu_icon block md:hidden" @click="clickMenu">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
          viewBox="0 0 24 24"
